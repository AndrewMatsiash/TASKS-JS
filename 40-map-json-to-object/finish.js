...
const parsePostsJSON = postsJSON.map((post) => JSON.parse(post));

console.log(parsePostsJSON);
console.log(parsePostsJSON[1].postId);
console.log(parsePostsJSON.at(-1).commentsQuantity);
